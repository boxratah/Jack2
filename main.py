...
# Comprehensive list of email domains for maximum hits
EMAIL_DOMAINS = [
    'gmail.com', 'yahoo.com', 'hotmail.com', 'aol.com', 'outlook.com',
    'icloud.com', 'protonmail.com', 'zoho.com', 'yandex.com', 'gmx.com',
    'mail.com', 'fastmail.com', 'tutanota.com', 'hubspot.com', 'hey.com',
    'icloud.com', 'me.com', 'mac.com', 'live.com', 'msn.com',
    'comcast.net', 'verizon.net', 'att.net', 'sbcglobal.net', 'bellsouth.net',
    'earthlink.net', 'cox.net', 'rediffmail.com', 'sky.com', 'orange.fr',
    'sfr.fr', 'free.fr', 'laposte.net', 'web.de', 'gmx.de',
    't-online.de', 'alice.it', 'libero.it', 'virgilio.it', 'tim.it',
    'naver.com', 'daum.net', 'nate.com', 'hanmail.net', 'seznam.cz',
    'azet.sk', 'onet.pl', 'wp.pl', 'o2.pl', 'interia.pl',
    'mail.ru', 'yandex.ru', 'rambler.ru', 'list.ru', 'bk.ru',
    'inbox.ru', 'qq.com', '163.com', '126.com', 'sina.com',
    'sohu.com', '139.com', '189.cn', 'wo.com.cn', '21cn.com',
    'foxmail.com', 'tom.com', 'eyou.com', '263.net', 'x263.net',
    'china.com', 'sogou.com', 'elong.com', 'netease.com', 'yeah.net',
    '126.com', '188.com', 'vip.qq.com', 'vip.163.com', 'vip.sina.com'
]
...
def check_gmail(email):
    ...
    try:
        ...
        headers = {
            ...
            'google-accounts-xsrf': '1',
            'origin': 'https://accounts.google.com',
            'referer': f'https://accounts.google.com/signup/v2/createusername?service=mail&continue=https%3A%2F%2Fmail.google.com%2Fmail%极速模式
            'user-agent': ggb(),
        }

        params = {'TL': tl}
        data = (
            'continue=https%3A%2F%2Fmail.google.com%2Fmail%2Fu%2F0%2F&dd极速模式
            f'&f.req=%5B%22TL%3A{tl}%22%2C%22{email}%22%2C0%2C0%2C1%2Cnull%2C0%2C5167%5D&azt=AFoagUUtRlvV928oS9O7F6eeI4dCO2r1ig%3A1712322460888&cookiesDisabled=false&deviceinfo=%5Bnull%2Cnull%2Cnull%2Cnull%2Cnull%2C%22NL%22极速模式
        )
        response = pp(
...
def check(email):
    ...
    if email in response:
        # For Gmail and AOL, use the specific checking functions
        if '@gmail.com' in email:
            check_gmail(email)
        elif '@aol.com' in email:
            check_aol(email)
        else:
            # For other domains, count as a hit immediately
            hits += 1
            pppp()
            if '@' in email:
                username, gg = email.split('@')
                ...
                # If no @ symbol, use the full email as username
                username = email
                gg = "unknown"
                InfoAcc(username, gg)
        goodig += 1
...
def rest(user):
  try:
    ...
    'X-Bloks-Version-Id': 'c80极速模式
    'X-IG-Connection-Type': '极速模式
